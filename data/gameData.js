...
const SKILLS = [
    ...
    { id: 'rank_sniper_1', name: 'ランクスナイパー I', description: 'Cランク以上の魚しか釣れなくなる', effect: { type: 'rank_sniper', minRarity: 'C' }, price: 2000, tier: 1, group: '探索グループ', icon: 'radar' },
    { id: 'rank_sniper_2', name: 'ランクスナイパー II', description: 'Bランク以上の魚しか釣れなくなる', effect: { type: 'rank_sniper', minRarity: 'B' }, price: 6000, tier: 2, group: '探索グループ', icon: 'radar' },
    { id: 'rank_sniper_3', name: 'ランクスナイパー III', description: 'Aランク以上の魚しか釣れなくなる', effect: { type: 'rank_sniper', minRarity: 'A' }, price: 20000, tier: 3, group: '探索グループ', icon: 'radar' },
    { id: 'rank_sniper_4', name: 'ランクスナイパー 極', description: 'Sランク以上の魚しか釣れなくなる', effect: { type: 'rank_sniper', minRarity: 'S' }, price: 100000, tier: 4, group: '探索グループ', icon: 'radar' },
    ...
    { id: 'fever_bias_sun_1', name: '太陽の好意 I', description: 'おたからフィーバー確率 +10%', effect: { type: 'fever_bias_sun', value: 0.1 }, price: 5000, tier: 1, group: '特殊効果グループ', icon: 'auto_awesome' },
    { id: 'fever_bias_sun_2', name: '太陽の好意 II', description: 'おたからフィーバー確率 +20%', effect: { type: 'fever_bias_sun', value: 0.2 }, price: 15000, tier: 2, group: '特殊効果グループ', icon: 'auto_awesome' },
    { id: 'fever_bias_sun_3', name: '太陽の好意 III', description: 'おたからフィーバー確率 +35%', effect: { type: 'fever_bias_sun', value: 0.35 }, price: 50000, tier: 3, group: '特殊効果グループ', icon: 'auto_awesome' },
    { id: 'fever_bias_sun_4', name: '太陽の好意 極', description: 'おたからフィーバー確率 +60%', effect: { type: 'fever_bias_sun', value: 0.6 }, price: 150000, tier: 4, group: '特殊効果グループ', icon: 'auto_awesome' },
    { id: 'fever_bias_moon_1', name: '月の好意 I', description: 'おさかなフィーバー確率 +10%', effect: { type: 'fever_bias_moon', value: 0.1 }, price: 5000, tier: 1, group: '特殊効果グループ', icon: 'auto_awesome' },
    { id: 'fever_bias_moon_2', name: '月の好意 II', description: 'おさかなフィーバー確率 +20%', effect: { type: 'fever_bias_moon', value: 0.2 }, price: 15000, tier: 2, group: '特殊効果グループ', icon: 'auto_awesome' },
    { id: 'fever_bias_moon_3', name: '月の好意 III', description: 'おさかなフィーバー確率 +35%', effect: { type: 'fever_bias_moon', value: 0.35 }, price: 50000, tier: 3, group: '特殊効果グループ', icon: 'auto_awesome' },
    { id: 'fever_bias_moon_4', name: '月の好意 極', description: 'おさかなフィーバー確率 +60%', effect: { type: 'fever_bias_moon', value: 0.6 }, price: 150000, tier: 4, group: '特殊効果グループ', icon: 'auto_awesome' },
    ...
    { id: 'godly_power_1', name: '神の力 I', description: 'パワー+50 & 失敗時ロスト率50%低減', effect: { type: 'godly_power', power: 50, safety: 0.5 }, price: 10000, tier: 1, group: '特殊スキルグループ', icon: 'workspace_premium' },
    { id: 'godly_power_2', name: '神の力 II', description: 'パワー+80 & 失敗時ロスト率75%低減', effect: { type: 'godly_power', power: 80, safety: 0.75 }, price: 30000, tier: 2, group: '特殊スキルグループ', icon: 'workspace_premium' },
    { id: 'godly_power_3', name: '神の力 III', description: 'パワー+120 & 失敗ペナルティを完全に無効化', effect: { type: 'godly_power', power: 120, safety: 1 }, price: 80000, tier: 3, group: '特殊スキルグループ', icon: 'workspace_premium' },
    { id: 'godly_power_4', name: '神の力 極', description: 'パワー+200 & ペナルティ無効 & パワー1.5倍', effect: { type: 'godly_power', power: 200, safety: 1, multiplier: 1.5 }, price: 250000, tier: 4, group: '特殊スキルグループ', icon: 'workspace_premium' },
    { id: 'golden_touch_1', name: '黄金の指先 I', description: '売値+50% & 闇取引の没収を50%回避', effect: { type: 'golden_touch', boost: 0.5, safety: 0.5 }, price: 10000, tier: 1, group: '特殊スキルグループ', icon: 'workspace_premium' },
    { id: 'golden_touch_2', name: '黄金の指先 II', description: '売値+100% & 闇取引の没収を75%回避', effect: { type: 'golden_touch', boost: 1, safety: 0.75 }, price: 30000, tier: 2, group: '特殊スキルグループ', icon: 'workspace_premium' },
    { id: 'golden_touch_3', name: '黄金の指先 III', description: '売値+200% & 闇取引のペナルティを無効化', effect: { type: 'golden_touch', boost: 2, safety: 1 }, price: 80000, tier: 3, group: '特殊スキルグループ', icon: 'workspace_premium' },
    { id: 'golden_touch_4', name: '黄金の指先 極', description: '売値+400% & ペナルティ無効 & 全売却価格2倍', effect: { type: 'golden_touch', boost: 4, safety: 1, multiplier: 2 }, price: 250000, tier: 4, group: '特殊スキルグループ', icon: 'workspace_premium' },
    { id: 'master_angler_1', name: 'Master Angler I', description: 'キャッチ率+30% & 赤ゾーン+50%', effect: { type: 'master_angler', catch: 0.3, redZone: 0.5 }, price: 10000, tier: 1, group: '特殊スキルグループ', icon: 'workspace_premium' },
    { id: 'master_angler_2', name: 'Master Angler II', description: 'キャッチ率+50% & 赤ゾーン+100%', effect: { type: 'master_angler', catch: 0.5, redZone: 1 }, price: 30000, tier: 2, group: '特殊スキルグループ', icon: 'workspace_premium' },
    { id: 'master_angler_3', name: 'Master Angler III', description: 'キャッチ率+80% & 赤ゾーン+150%', effect: { type: 'master_angler', catch: 0.8, redZone: 1.5 }, price: 80000, tier: 3, group: '特殊スキルグループ', icon: 'workspace_premium' },
    { id: 'master_angler_4', name: 'Master Angler 極', description: 'キャッチ率+150% & 赤ゾーン+300% & ゲージ低速化', effect: { type: 'master_angler', catch: 1.5, redZone: 3, slow: 0.5 }, price: 250000, tier: 4, group: '特殊スキルグループ', icon: 'workspace_premium' },
    { id: 'eternal_fever_1', name: '永遠の熱狂 I', description: 'フィーバー蓄積+50% & 継続率+30%', effect: { type: 'eternal_fever', charge: 0.5, sustain: 0.3 }, price: 10000, tier: 1, group: '特殊スキルグループ', icon: 'workspace_premium' },
    { id: 'eternal_fever_2', name: '永遠の熱狂 II', description: 'フィーバー蓄積+100% & 継続率+60%', effect: { type: 'eternal_fever', charge: 1, sustain: 0.6 }, price: 30000, tier: 2, group: '特殊スキルグループ', icon: 'workspace_premium' },
    { id: 'eternal_fever_3', name: '永遠の熱狂 III', description: 'フィーバー蓄積3倍 & フィーバーが減らなくなる', effect: { type: 'eternal_fever', charge: 2, sustain: 1 }, price: 80000, tier: 3, group: '特殊スキルグループ', icon: 'workspace_premium' },
    { id: 'eternal_fever_4', name: '永遠の熱狂 極', description: '蓄積5倍 & 常時維持 & フィーバー報酬3倍', effect: { type: 'eternal_fever', charge: 4, sustain: 1, multiplier: 3 }, price: 250000, tier: 4, group: '特殊スキルグループ', icon: 'workspace_premium' },
    { id: 'cosmic_blessing_1', name: '宇宙の加護 I', description: '太陽・月の加護を同時適用 (効果1.5倍)', effect: { type: 'cosmic_blessing', value: 1.5 }, price: 10000, tier: 1, group: '特殊スキルグループ', icon: 'workspace_premium' },
    { id: 'cosmic_blessing_2', name: '宇宙の加護 II', description: '太陽・月の加護を同時適用 (効果2.5倍)', effect: { type: 'cosmic_blessing', value: 2.5 }, price: 30000, tier: 2, group: '特殊スキルグループ', icon: 'workspace_premium' },
    { id: 'cosmic_blessing_3', name: '宇宙の加護 III', description: '太陽・月の加護を同時適用 (効果5倍)', effect: { type: 'cosmic_blessing', value: 5 }, price: 80000, tier: 3, group: '特殊スキルグループ', icon: 'workspace_premium' },
    { id: 'cosmic_blessing_4', name: '宇宙の加護 極', description: '全加護同時適用 (10倍) & 全レベル上昇速度2倍', effect: { type: 'cosmic_blessing', value: 10, speed: 2 }, price: 250000, tier: 4, group: '特殊スキルグループ', icon: 'workspace_premium' },
